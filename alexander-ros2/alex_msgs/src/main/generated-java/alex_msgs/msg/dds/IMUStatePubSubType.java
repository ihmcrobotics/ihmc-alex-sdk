...
*
*/
public class IMUStatePubSubType implements us.ihmc.pubsub.TopicDataType<alex_msgs.msg.dds.IMUState>
{
   ...
   {
   		return "6b85bb2a6044d3837ee77ce5ba1e5d3ee7f930e2305e76232b3a7553a53e74b7";
   }
   ...
   @Override
   public void serialize(alex_msgs.msg.dds.IMUState data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, alex_msgs.msg.dds.IMUState data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(alex_msgs.msg.dds.IMUState data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(alex_msgs.msg.dds.IMUState data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(alex_msgs.msg.dds.IMUState data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(alex_msgs.msg.dds.IMUState data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(alex_msgs.msg.dds.IMUState data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, alex_msgs.msg.dds.IMUState data)
   {
   ...
   public static void staticCopy(alex_msgs.msg.dds.IMUState src, alex_msgs.msg.dds.IMUState dest)
   {
      dest.set(src);
   }

   @Override
   public alex_msgs.msg.dds.IMUState createData()
   {
      return new alex_msgs.msg.dds.IMUState();
   }
   @Override
   ...
   public void serialize(alex_msgs.msg.dds.IMUState data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(alex_msgs.msg.dds.IMUState data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(alex_msgs.msg.dds.IMUState src, alex_msgs.msg.dds.IMUState dest)
   {
      staticCopy(src, dest);
   }
