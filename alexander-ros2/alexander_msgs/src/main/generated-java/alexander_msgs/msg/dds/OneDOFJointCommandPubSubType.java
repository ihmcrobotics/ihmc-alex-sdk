...
*
*/
public class OneDOFJointCommandPubSubType implements us.ihmc.pubsub.TopicDataType<alexander_msgs.msg.dds.OneDOFJointCommand>
{
   public static final java.lang.String name = "alexander_msgs::msg::dds_::OneDOFJointCommand_";
   ...
   @Override
   public void serialize(alexander_msgs.msg.dds.OneDOFJointCommand data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, alexander_msgs.msg.dds.OneDOFJointCommand data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(alexander_msgs.msg.dds.OneDOFJointCommand data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(alexander_msgs.msg.dds.OneDOFJointCommand data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void read(alexander_msgs.msg.dds.OneDOFJointCommand data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(alexander_msgs.msg.dds.OneDOFJointCommand data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, alexander_msgs.msg.dds.OneDOFJointCommand data)
   {
   ...
   public static void staticCopy(alexander_msgs.msg.dds.OneDOFJointCommand src, alexander_msgs.msg.dds.OneDOFJointCommand dest)
   {
      dest.set(src);
   }

   @Override
   public alexander_msgs.msg.dds.OneDOFJointCommand createData()
   {
      return new alexander_msgs.msg.dds.OneDOFJointCommand();
   }
   @Override
   ...
   public void serialize(alexander_msgs.msg.dds.OneDOFJointCommand data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(alexander_msgs.msg.dds.OneDOFJointCommand data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(alexander_msgs.msg.dds.OneDOFJointCommand src, alexander_msgs.msg.dds.OneDOFJointCommand dest)
   {
      staticCopy(src, dest);
   }
