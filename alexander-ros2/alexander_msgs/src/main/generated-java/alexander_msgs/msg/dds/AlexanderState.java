...
/**
       ...
       */
public class AlexanderState extends Packet<AlexanderState> implements Settable<AlexanderState>, EpsilonComparable<AlexanderState>
{
   /**
            * General Status
            */
   ...
   /**
            * Joint States
            */
   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.OneDOFJointState>  joint_states_;
   /**
            * Sensor States
            */
   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.IMUState>  imu_states_;
   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.ForceTorqueState>  ft_states_;

   public AlexanderState()
   {
      joint_states_ = new us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.OneDOFJointState> (50, new alexander_msgs.msg.dds.OneDOFJointStatePubSubType());
      imu_states_ = new us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.IMUState> (50, new alexander_msgs.msg.dds.IMUStatePubSubType());
      ft_states_ = new us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.ForceTorqueState> (50, new alexander_msgs.msg.dds.ForceTorqueStatePubSubType());

   }

   public AlexanderState(AlexanderState other)
   {
      this();
      set(other);
   }

   public void set(AlexanderState other)
   {
      time_ = other.time_;
   ...
   /**
            * Joint States
            */
   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.OneDOFJointState>  getJointStates()
   {
   ...
   /**
            * Sensor States
            */
   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.IMUState>  getImuStates()
   {
      return imu_states_;
   }


   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.ForceTorqueState>  getFtStates()
   {
      return ft_states_;
   }


   public static Supplier<AlexanderStatePubSubType> getPubSubType()
   {
      return AlexanderStatePubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(AlexanderState other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof AlexanderState)) return false;

      AlexanderState otherMyClass = (AlexanderState) other;
