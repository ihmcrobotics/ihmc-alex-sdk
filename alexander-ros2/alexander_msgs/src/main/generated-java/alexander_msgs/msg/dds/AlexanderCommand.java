...
/**
       ...
       */
public class AlexanderCommand extends Packet<AlexanderCommand> implements Settable<AlexanderCommand>, EpsilonComparable<AlexanderCommand>
{
   /**
   ...
   /**
            ...
            */
   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.OneDOFJointCommand>  joint_commands_;
   public double low_level_master_gain_;

   public AlexanderCommand()
   {
      joint_commands_ = new us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.OneDOFJointCommand> (50, new alexander_msgs.msg.dds.OneDOFJointCommandPubSubType());

   }

   public AlexanderCommand(AlexanderCommand other)
   {
      this();
      set(other);
   }

   public void set(AlexanderCommand other)
   {
   ...
   /**
            * Joint Commands for the robot
            */
   public us.ihmc.idl.IDLSequence.Object<alexander_msgs.msg.dds.OneDOFJointCommand>  getJointCommands()
   {
   ...
   public static Supplier<AlexanderCommandPubSubType> getPubSubType()
   {
      return AlexanderCommandPubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(AlexanderCommand other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof AlexanderCommand)) return false;

      AlexanderCommand otherMyClass = (AlexanderCommand) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("AlexanderCommand {");
